...
export function Hero() {
  ...
  return (
    <section id='home' className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 text-center px-2 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-4">
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 font-light">
            Full Stack Developer || Programmer & Creative Technologist
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <button onClick={() => window.location.href = '/cv.pdf'} className="group border-2 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:bg-gray-900 hover:text-white hover:border-gray-900 dark:hover:bg-white dark:hover:text-gray-900 dark:hover:border-white flex items-center gap-2">
