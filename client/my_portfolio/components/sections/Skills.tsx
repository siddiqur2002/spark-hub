...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "JavaScript", level: 80, color: "bg-purple-500" },
    ],
  },
  {
    name: "Backend",
    skills: [
      ...
      { name: "MySQL", level: 70, color: "bg-pink-500" },
    ],
  },
  {
    name: "Tools & Others",
    skills: [
      { name: "Git/Github", level: 80, color: "bg-orange-600" },
      { name: "Docker", level: 45, color: "bg-blue-600" },
      { name: "AWS", level: 40, color: "bg-yellow-600" },
      { name: "Figma", level: 70, color: "bg-purple-600" },
      { name: "Jest", level: 70, color: "bg-red-600" },
